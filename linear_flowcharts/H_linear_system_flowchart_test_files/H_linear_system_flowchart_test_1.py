...
def generate_linear_flowchart(num_flowcharts, min_nodes, max_nodes):
    ...
    os.makedirs("linear_flowcharts/H_linear_system_flowchart_test_files/flowchart_img", exist_ok=True)
    os.makedirs("linear_flowcharts/H_linear_system_flowchart_test_files/mermaid_txt", exist_ok=True)
    ...
    for flowchart_index in range(1, num_flowcharts + 1):
        ...
        # Generate Mermaid code (adjusted for horizontal flow)
        ...
        flowchart_image_path = os.path.join(
            "linear_flowcharts/H_linear_system_flowchart_test_files/flowchart_img",
        ...
        mermaid_text_path = os.path.join(
            "linear_flowcharts/H_linear_system_flowchart_test_files/mermaid_txt",
